          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[1450px] text-left text-sm">
              ...
              <tbody className="divide-y dark:divide-slate-800">
                ...
                {!rows.length ? <tr><td colSpan={8} className="px-5 py-10 text-center text-slate-500">No active milestones for this supplier.</td></tr> : null}
              </tbody>
            </table>
          </div>
      ...
      <div className="mccs-card mt-6 overflow-hidden rounded-2xl">
        <div className="overflow-x-auto">
          <table className="w-full min-w-[1200px] text-left text-sm">
            <thead className="bg-slate-50 text-xs uppercase text-slate-500 dark:bg-slate-900">
              <tr><th className="px-5 py-3">PO</th><th className="px-5 py-3">Milestone</th><th className="px-5 py-3">%</th><th className="px-5 py-3">Calculated Amount</th><th className="px-5 py-3">Due</th><th className="px-5 py-3">Payment Due</th><th className="px-5 py-3">Status</th><th className="px-5 py-3">Actions</th></tr>
            </thead>
            <tbody className="divide-y dark:divide-slate-800">
              {rows.map((m: any) => {
                const p = pos.get(String(m.purchase_order_id));
              ...
              {!rows.length ? <tr><td colSpan={8} className="px-5 py-12 text-center text-slate-500">No payment milestones yet.</td></tr> : null}
            </tbody>
          </table>
        </div>
      </div>
