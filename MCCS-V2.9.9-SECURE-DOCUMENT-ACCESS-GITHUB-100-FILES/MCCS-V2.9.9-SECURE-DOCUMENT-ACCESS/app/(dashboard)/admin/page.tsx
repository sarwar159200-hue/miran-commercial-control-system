...
import { Activity, BriefcaseBusiness, Cloud, Coins, Network, Users, UploadCloud } from "lucide-react";

const cards = [
  { title: "Users & Roles", sub: "Create team accounts and assign access", href: "/admin/users", icon: Users },
  { title: "Projects & Packages", sub: "Create vendor-linked projects / supply packages", href: "/projects", icon: BriefcaseBusiness },
  ...
  { title: "Google Drive Configuration", sub: "Google Drive storage status and authorization", href: "/admin/google-drive", icon: Cloud },
  { title: "Historical Data Import", sub: "Load legacy vendors, packages, POs, milestones, invoices and payments", href: "/admin/historical-import", icon: UploadCloud },
