...
import { ProfileAvatarUploader, SignOutButton } from "@/components/sign-out-button";
          ...
          <div className="flex flex-1 items-center justify-end gap-4 pl-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <ProfileAvatarUploader
                ...
                displayName={profile?.preferred_name || profile?.full_name || user.email || "User"}
                initials={String(profile?.preferred_name || profile?.full_name || user.email || "U").slice(0, 2).toUpperCase()}
              />
              {isSuperAdmin ? (
