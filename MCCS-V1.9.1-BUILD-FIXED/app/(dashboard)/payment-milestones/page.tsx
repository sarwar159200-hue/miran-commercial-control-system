export default function Page() {
  return (
    <div className="mx-auto max-w-[1600px]">
      ...
      <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-950">Payment Milestones</h1>
      <p className="mt-2 text-sm text-slate-500">Create, forecast and monitor contractual payment milestones.</p>
