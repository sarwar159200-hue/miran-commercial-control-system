# MCCS V2.6.1 — Vendor / Project Commercial Document Hierarchy
...
## V2.6.1 build patch
- Fixed TypeScript inference in the Documents upload page by explicitly typing the PO lookup map.
- Prevents Vercel type-check failure where `po_number`, `project_id`, and `vendor_id` were inferred on `unknown`.
