  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-3"><a href={`/api/purchase-orders/${id}/pdf`} className="rounded-xl bg-blue-700 px-4 py-2.5 text-sm font-bold text-white">Export Miran PO PDF</a><Link href={`/documents/upload?po=${id}`} className="rounded-xl bg-[#07111f] px-4 py-2.5 text-sm font-bold text-white dark:bg-blue-600">Attach Document</Link><Link href={`/purchase-orders/${id}/edit`} className="rounded-xl border bg-white px-4 py-2.5 text-sm font-bold text-blue-700">Edit PO</Link><Link href="/purchase-orders" className="rounded-xl px-4 py-2.5 text-sm font-bold text-blue-700">Back to register</Link></div>
      </div>
