# MCCS — Miran Commercial Control System — V1.7
...
V1.7 updates Next.js to 15.5.21 and supports the current Supabase publishable-key environment variable name.
...
## V1.7
Full-screen login layout and improved Supabase login diagnostics.


## V2.0.3 Near-Go-Live
Functional vendor hierarchy, purchase-order creation, personalized welcome, online-user presence and Super Admin action logs.


## V2.0.3
Fixed nullable Supabase query results in the Super Admin Control Center for Vercel strict TypeScript builds.


## V2.0.3
Fixed nullable Supabase data arrays across Purchase Orders and Vendor pages for strict Vercel TypeScript builds.


## V2.0.3 Go-Live Controls
Vendor hierarchy, currency master, team accounts, PO amendments/hold/delete, initial payment milestones and Excel export are now functional.


## V2.0.3
Reliability patch for PO creation, milestone loading and dashboard error handling.


## V2.0.3
User Administration now detects the server admin credential dynamically and provides role/environment diagnostics.


## V2.0.3
Added Administration → Projects and rebuilt PO detail loading to eliminate false 'PO not found' results from fragile embedded relationship queries.
