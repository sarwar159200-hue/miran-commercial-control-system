# MCCS — Miran Commercial Control System — V1.4
...
V1.4 updates Next.js to 15.5.21 and supports the current Supabase publishable-key environment variable name.
