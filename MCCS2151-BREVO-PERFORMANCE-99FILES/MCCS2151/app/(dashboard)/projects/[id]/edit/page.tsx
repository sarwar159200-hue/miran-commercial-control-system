    ...
    <div className="mx-auto max-w-4xl">
      ...
      <form action={updateProject} className="mccs-card mt-7 rounded-2xl p-6">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div className="md:col-span-2 rounded-xl border border-slate-200 bg-slate-50 p-3 text-xs text-slate-600 dark:border-slate-700 dark:bg-slate-900/40 dark:text-slate-300">Duration on the Projects register is calculated automatically from Start Date to Planned Finish Date as calendar days, weeks and months. Working-day duration requires a defined project calendar.</div>
        </div>
