...
import { Activity, BriefcaseBusiness, Cloud, Coins, Network, Users } from "lucide-react";

const cards = [
  { title: "Users & Roles", sub: "Create team accounts and assign access", href: "/admin/users", icon: Users },
  { title: "Projects", sub: "Create and manage project master data", href: "/admin/projects", icon: BriefcaseBusiness },
