...
const DEFAULT_EMAIL = "sarwar.khalid@miranenergy.com";
    ...
    try {
      ...
      if (error) {
        ...
        if (normalized.includes("invalid login credentials")) {
          setError(
            "Supabase rejected the sign-in. Confirm this exact email exists in Supabase → Authentication → Users and that the password was set for that user."
          );
      ...
      // One navigation only. Avoid router.replace + router.refresh, which can trigger\n      // duplicate dashboard work inside Android WebView and delay the menu.\n      window.location.replace("/dashboard");
    } catch (err) {
      setError(
