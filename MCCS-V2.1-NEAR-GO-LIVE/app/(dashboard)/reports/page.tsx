export default function Page() {
  return (
    <div className="mx-auto max-w-[1600px]">
      ...
      <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-950">Reports</h1>
      <p className="mt-2 text-sm text-slate-500">Commercial reporting, cash flow, aging and audit exports.</p>
