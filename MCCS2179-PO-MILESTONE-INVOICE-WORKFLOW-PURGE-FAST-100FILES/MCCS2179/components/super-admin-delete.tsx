      ...
      <div className="w-full max-w-2xl rounded-2xl bg-white shadow-2xl dark:bg-slate-950">
        ...
        <div className="space-y-5 p-5">
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900 dark:bg-amber-950/20 dark:text-amber-100">
            {purge ? <>This is a <b>permanent purge</b>. For a deleted PO, Super Admin can permanently remove the PO and its linked MCCS commercial database records. A minimal purge audit event is retained. Google Drive files are not physically deleted by this action.</> : <>This is an <b>audit-safe soft delete</b>. The record will disappear from normal MCCS registers and reports, but the database audit trail will be retained. Google Drive files are not physically deleted by this action.</>}
          </div>
